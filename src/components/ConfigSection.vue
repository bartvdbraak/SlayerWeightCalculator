<template>
    <section>
        <div class="pt-3 pb-2 my-2">
            ...
            <b-row>
                    <b-col sm="6" md="4" v-for="questUnlock in questUnlocks" v-bind:key="questUnlock.id">
                        <b-form-checkbox
                                class="mb-1"
...
export default {
	...
	data() {
	    return {
	    	...
	    	pointUnlocks: [
		        {id: 0, name: 'Seeing red', monster_ids: [83, 3], unlock: false},
		        ...
		        {id: 7, name: 'Basilocked', monster_ids: [7], unlock: false, block: true},
	        ],
			blockList: [
